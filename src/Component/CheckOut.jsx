      ...
      <div>
        ...
        <div className="text-center">
          <p style={{ fontSize: "small" }} className="text-success">
            <i class="bi bi-shield-fill-check "></i> 100% Payment Protection,
            Easy Return Policy
          </p>
          <p className="mb-1">
            <span>
          ...
          <p style={{ fontSize: "x-small" }} className="">
            ...
            <span className="link-offset-2">Terms and Condition</span> and{" "}
            <span className="link-offset-2">Privacy Policy</span>.
          </p>
        </div>
      </div>
    ),NetBanking:<h1>NetBanking</h1>,
    Wallets:<h1>Wallets</h1>,
    COD:<h1>COD</h1>
  };
  let RedeemCode = (
