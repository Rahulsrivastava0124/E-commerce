...
export default [
  ...
  <Route path="/Profile" element={<ProfileContainer />} key="profile">
    ...
    />
    <Route path="ContactUs" element={<ContactUs />} key="contacts" />
  </Route>,
  <Route
    path="/profile/Addresses"
    element={<ProtectedComponentContainer Component={UserAdressesContainer} />}
    key="Address"
  />,
  <Route path="/WishList" element={<WishListContainer />} key="wishlist" />,
  <Route
    path="/Profile/YourOrder"
    element={<ProtectedComponentContainer Component={YourOrderContainer} />}
    key="yourOrder"
  />,
  <Route path="/CheckOut" element={<CheckOutContainer />} key="checkout" />,
  <Route
    path="/ProductPreview"
    element={<PreviewProductContainer />}
    key="productpreview"
  />,
  <Route
    path="/CheckOut/OrderPlaced"
    element={
      <ProtectedComponentContainer Component={OrderPlaced} key="orderPlaced" />
    }
    key="orderplaced"
  />,
