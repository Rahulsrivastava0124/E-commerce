  ...
  return (
    <>
        ...
        <div className="modal-dialog  w-25">
          <div className="modal-content p-3 d-flex align-items-center">
            <span
              ...
              className="d-flex align-items-center justify-content-center bg-danger-subtle rounded-circle"
            >
            ...
            <div className="modal-body">
              ...
              <span className="text-warning">Remove</span> your{" "}
              ...
              <div className="border rounded mt-3 p-2 bg-danger-subtle text-capitalize text-danger-emphasis">
                <span className="fw-bold">
                  {!RemoveData == "" ? RemoveData.name : null}
                </span>
                <br />
                <span>{!RemoveData == "" ? RemoveData.street : null}</span>
                <br />
            ...
            <div className="d-flex justify-content-around w-75">
              ...
              <button
                className="btn btn-danger ms-4 w-50 "
                onClick={() => RemoveAddressCard(RemoveData.uniqueID)}
                data-bs-dismiss="modal"
                aria-label="Close"
              >
      ...
      {getUserLoading ? (
        ...
        <>
          <AddressInput
            userData={props.data.UserLogin.LoginData.state._id}
            InputValue={formData}
          ...
          <div className="container-md d-flex  flex-wrap m-auto">
            <div
              className="dotted_border Address_card bg-body-tertiary mx-3 d-flex justify-content-evenly align-items-center mb-4"
            ...
            {AddressData.map((data, index) => {
              return (
                <div
                  className={`Address_card  border p-3 bg-body-tertiary rounded-3 mx-3 position-relative mb-4 ${
                    data.select ? "border-success" : null
                  }`}
                  key={data.uniqueID}
                >
                  <div className="d-flex justify-content-between">
                    <p className="fw-bold m-0"> {data.name}</p>
                    <span className="badge bg-secondary text-bg-primary">
                      {data.type}
                    </span>
                  </div>
                  ...
                  <div className="position-absolute d-flex align-items-center bottom-0 end-0">
                    {data.select ? (
                      <span className="badge m-2 text-bg-primary span_btn">
                        Active
                      </span>
                    ) : (
                      <span className=" btn m-2 btn-sm span_btn btn-outline-primary rounded-3 py-0 fw-bold">
                        select
                      </span>
                    )}
                    <span
